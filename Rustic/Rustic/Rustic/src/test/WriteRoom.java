...
public class WriteRoom extends JFrame {
	...
	public WriteRoom() {
		...
		JButton btnReview = new JButton("Write");
		btnReview.setFont(new Font("Dialog", Font.BOLD, 14));
		...
		JLabel lblActivityInfo = new JLabel("◇ 숙박 매물 작성");
		lblActivityInfo.setForeground(Color.WHITE);
		lblActivityInfo.setFont(new Font("함초롬돋움", Font.BOLD, 15));
