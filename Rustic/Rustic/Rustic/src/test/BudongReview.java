...
public class BudongReview extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BudongReview frame = new BudongReview();
	...
	public BudongReview() {
		...
		JLabel lblBudongReview = new JLabel("◇ 부동산(장기숙박) 리뷰작성하기");
		lblBudongReview.setForeground(Color.WHITE);
		lblBudongReview.setFont(new Font("함초롬돋움", Font.BOLD, 15));
		lblBudongReview.setBounds(37, 10, 298, 38);
		contentPane.add(lblBudongReview);
