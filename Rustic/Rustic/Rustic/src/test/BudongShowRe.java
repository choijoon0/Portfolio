...
public class BudongShowRe extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BudongShowRe frame = new BudongShowRe();
	...
	public BudongShowRe() {
		...
		JLabel lblBudongShowRe = new JLabel("°ﬁ ∫ŒµøªÛ(¿Â±‚º˜π⁄) ∏Æ∫‰∫∏±‚");
		lblBudongShowRe.setForeground(Color.WHITE);
		lblBudongShowRe.setFont(new Font("«‘√ ∑“µ∏øÚ", Font.BOLD, 15));
		lblBudongShowRe.setBounds(27, 24, 298, 38);
		contentPane.add(lblBudongShowRe);
	}
