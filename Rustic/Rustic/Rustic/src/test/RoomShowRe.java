...
public class RoomShowRe extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RoomShowRe frame = new RoomShowRe();
	...
	public RoomShowRe() {
		...
		JLabel lblRoomShowRe = new JLabel("°ﬁ º˜π⁄ ∏Æ∫‰∫∏±‚");
		lblRoomShowRe.setForeground(Color.WHITE);
		lblRoomShowRe.setFont(new Font("«‘√ ∑“µ∏øÚ", Font.BOLD, 15));
		lblRoomShowRe.setBounds(27, 24, 298, 38);
		contentPane.add(lblRoomShowRe);
	}
