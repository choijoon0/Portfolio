...
public class MyPage extends JPanel {
   ...
   public MyPage(String id, int gubun) {
      ...
      Tx_Name.setFont(new Font("Dialog", Font.PLAIN, 14));
      ...
      MyID.setFont(new Font("Dialog", Font.BOLD, 14));
      MyID.setBounds(12, 10, 67, 35);
      AddrPanel.add(MyID);
      
      JLabel Tx_ID = new JLabel();
      Tx_ID.setFont(new Font("Dialog", Font.PLAIN, 14));
      ...
      Tx_Phone.setFont(new Font("Dialog", Font.PLAIN, 14));
      ...
      panel.setBounds(195, 60, 432, 333);
      add("Center",panel);
      panel.setLayout(null);
      
      JScrollPane scrollPane = new JScrollPane( table );
      scrollPane.setBounds(12, 20, 408, 303);
      panel.add(scrollPane);
      
      renum = new JTextField();
      renum.setBounds(12, 297, 106, 21);
      add(renum);
      renum.setColumns(10);
