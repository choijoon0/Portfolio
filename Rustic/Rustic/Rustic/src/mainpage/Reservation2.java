...
public class Reservation2 extends JFrame {
	...
	*/
	...
	public Reservation2(int select_bumenunum, String id) {	
		...
		//입실 날짜
		JButton checkinBtn = new JButton("날짜 선택");
		...
		//퇴실날짜
		JButton checkoutBtn = new JButton("날짜 선택");
		...
		lblDateView.setFont(new Font("Dialog", Font.BOLD, 14));
		...
		lblNewLabel_12.setFont(new Font("굴림", Font.BOLD, 16));
