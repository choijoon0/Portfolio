...
*/
   ...
   public FrameDashboard_owner(Object ...n) {
      ...
      lblOrders.setFont(new Font("Dialog", Font.BOLD, 15));
      ...
      JLabel lblSettings = new JLabel("\uB9E4\uB9E4\uBB3C\uD488\uB4F1\uB85D");
      lblSettings.setForeground(Color.WHITE);
      lblSettings.setFont(new Font("Dialog", Font.BOLD, 15));
   ...
   public class panelRoomRentWrite extends JPanel {
      ...
      public panelRoomRentWrite(Object ...n) {
         ...
         rentOwnerPhone.setFont(new Font("Dialog", Font.BOLD, 14));
         ...
         rentRoomWriteBtn.setFont(new Font("함초롬돋움", Font.BOLD, 14));
         rentRoomWriteBtn.setBackground(new Color(0, 128, 128));
         ...
         btnNewButton.setBounds(298, 5, 81, 23);
         ...
         roomRentInfoTitle_1.setBounds(71, 10, 140, 25);
         ...
         squareftTxbox.setBounds(80, 6, 46, 21);
         ...
         direcTxbox.setBounds(85, 0, 46, 21);
...
//판넬 매매   
   ...
   public asd(int menunum) {
      ...
      JButton rentRoomWriteBtn = new JButton("\uC218\uC815\uD558\uAE30");
      ...
      rentRoomWriteBtn.setBackground(new Color(0, 128, 128));
      rentRoomWriteBtn.setBounds(498, 393, 120, 45);
      getContentPane().add(rentRoomWriteBtn);
   ...
   public class budong extends JFrame {
	   ...
	   public budong(int numnum) {
	      ...
	      JButton saleRoomWriteBtn = new JButton("\uC218\uC815 \uD558\uAE30");
	      
	     
	      saleRoomWriteBtn.setFont(new Font("함초롬돋움", Font.BOLD, 14));
	      saleRoomWriteBtn.setBackground(new Color(0, 128, 128));
	      saleRoomWriteBtn.setBounds(498, 393, 120, 45);
	      getContentPane().add(saleRoomWriteBtn);
