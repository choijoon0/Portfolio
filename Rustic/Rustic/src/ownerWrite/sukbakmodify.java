...
public class sukbakmodify extends JFrame {
	   ...
	   public sukbakmodify() {
	      ...
	      rentcountToiletRoomPanel_1_1.setBounds(12, 161, 162, 34);
	      ...
	      ArrayList list = dao1.select(menunum);
