...
public class ZipSearch extends JFrame {
	...
	*/
    ...
    public ZipSearch(String id, int gubun, int roomgubun) {
           ...
           sidoBox.setFont(new Font("바탕", Font.PLAIN, 12));
           ...
           label.setFont(new Font("바탕", Font.BOLD, 12));
           ...
           gugunBox.setFont(new Font("바탕", Font.PLAIN, 12));
           gugunBox.setBounds(258, 40, 100, 20);
           panel.add(gugunBox);
          
           JLabel label_1 = new JLabel("구.군");
           label_1.setForeground(new Color(255, 255, 255));
           label_1.setFont(new Font("바탕", Font.BOLD, 12));
           ...
           dongBox.setFont(new Font("바탕", Font.PLAIN, 12));
           dongBox.setBounds(370, 40, 100, 20);
           panel.add(dongBox);
          
           JLabel label_2 = new JLabel("동");
           label_2.setForeground(new Color(255, 255, 255));
           label_2.setFont(new Font("바탕", Font.BOLD, 12));
...
//           동이름 검색 패널
           ...
           lblNewLabel.setFont(new Font("바탕", Font.BOLD, 12));
           lblNewLabel.setBounds(181, 26, 36, 15);
           panel_1.add(lblNewLabel);
           
           tfDong = new JTextField(20);
           tfDong.setFont(new Font("바탕", Font.PLAIN, 12));
           tfDong.setBounds(222, 23, 116, 21);
           panel_1.add(tfDong);
           tfDong.setColumns(10);
           
           JButton btnDongSearce = new JButton("\uAC80 \uC0C9");
           btnDongSearce.setForeground(new Color(255, 255, 255));
           btnDongSearce.setBackground(new Color(47, 79, 79));
           btnDongSearce.setFont(new Font("바탕", Font.BOLD, 12));
           ...
           pbtn.setBackground(new Color(47, 79, 79));
           pbtn.setFont(new Font("바탕", Font.BOLD, 12));
