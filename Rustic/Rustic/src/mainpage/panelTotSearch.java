...
public class panelTotSearch extends JPanel {
	...
	public panelTotSearch(String id) {
		...
		//임시 라벨들
		JLabel lblNewLabel = new JLabel("\uC219\uBC29/\uB9E4\uBB3C \uD1B5\uD569\uAC80\uC0C9");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setFont(new Font("바탕", Font.BOLD, 17));
		lblNewLabel.setBounds(68, 73, 230, 35);
		add(lblNewLabel);
		...
		panel_1.setBounds(284, 73, 318, 35);
		add(panel_1);
		panel_1.setLayout(null);
		comboBox1 = new JComboBox( searchText );
		comboBox1.setFont(new Font("바탕", Font.PLAIN, 12));
		comboBox1.setBounds(12, 6, 75, 21);
		//comboBox1.setModel(new DefaultComboBoxModel(new String[] {"\uC774\uB984", "\uC8FC\uC18C", "\uC0C1\uC138 \uC8FC\uC18C"}));
		panel_1.add(comboBox1);
		
		searchtx = new JTextField();
		searchtx.setFont(new Font("바탕", Font.PLAIN, 12));
		searchtx.setBounds(99, 6, 122, 21);
		panel_1.add(searchtx);
		searchtx.setColumns(10);
		
		JButton searchBtn = new JButton("\uAC80\uC0C9");
		searchBtn.setFont(new Font("바탕", Font.PLAIN, 12));
		searchBtn.setBounds(233, 5, 73, 23);
