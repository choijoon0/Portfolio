...
public class Reservation2 extends JFrame {
	...
	*/
	 ...
	 * @param id 
	 */
	public Reservation2(int select_bumenunum, String id) {	
		...
		contentPane.add(lblCustomerInfo);
		 ...
		 Tx_Title.setFont(new Font("πŸ≈¡", Font.PLAIN, 12));
	      ...
	      Tx_Title.setText(String.valueOf(select_bumenunum));
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					try {
						resdao.insertres(paymethodCombo.getSelectedItem().toString(), select_bumenunum, custnum, startdateBox.getText(), enddateBox.getText(), peoplecntcombo.getSelectedItem().toString(), diffDays);
		...
		ArrayList list = dao1.select_All2(select_bumenunum);
