...
public class ActivityReview extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActivityReview frame = new ActivityReview();
	...
	public ActivityReview() {
		...
		JLabel lblRoomReview = new JLabel("°ﬁ ¡÷∫Ø ≥Ó ∞˜ ∏Æ∫‰¿€º∫«œ±‚");
		lblRoomReview.setForeground(Color.WHITE);
		lblRoomReview.setFont(new Font("«‘√ ∑“µ∏øÚ", Font.BOLD, 15));
